\begin{spell}{Antagonize}{TBMT}{3rd-Level Enchantment}
{
	\spTime{1 acti}
	\spRange{g Time: 1 acti}
	\spComponents{e: 1 acti}
	\spDuration{ime: 1 action}
}
Range: 30 feet
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d4 for each slot level above 3rd.
\end{spell}
...
\begin{spell}{Antagonize (UA)}{UA-85}{3rd-level enchantment}
{
	\spTime{1 action}
	\spRange{30 feet}
	\spComponents{V, S, M (a playing card depicting a rogue)}
...
\begin{spell}{Bestow Curse}{PHB}{3rd-level necromancy}
{
	\spTime{1 action}
	\spRange{Touch}
	\spComponents{V, S}
...
\note{At Higher Levels.} If you cast this spell using a spell slot of 4th level or higher, the duration is concentration, up to 10 minutes. If you use a spell slot of 5th level or higher, the duration is 8 hours. If you use a spell slot of 7th level or higher, the duration is 24 hours. If you use a 9th level spell slot, the spell lasts until it is dispelled. Using a spell slot of 5th level or higher grants a duration that doesn't require concentration.
\end{spell}
...
\begin{spell}{Clairvoyance}{PHB}{3rd-level divination}
{
	\spTime{10 minutes}
	\spRange{1 mile}
	\spComponents{V, S, M (a focus worth at least 100 gp, either a jeweled horn for hearing or a glass eye for seeing)}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, you automatically end the effects of a spell on the target if the spell's level is equal to or less than the level of the spell slot you used.
\end{spell}
...
\begin{spell}{Fast Friends}{A Inc.}{3rd-level enchantment}
{
	\spTime{1 action}
	\spRange{30 feet}
	\spComponents{V}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, you can target one additional creature for each slot level above 3rd.
\end{spell}

\begin{spell}{Fear}{PHB}{3rd-level illusion}
{
	\spTime{1 action}
	\spRange{Self (30-foot cone)}
	\spComponents{V, S, M (a white feather or the heart of a hen)}
	\spDuration{Concentration, up to 1 minute}
}
...
\begin{spell}{Feign Death}{PHB}{3rd-level necromancy (ritual)}
{
	\spTime{1 action}
	\spRange{Touch}
	\spComponents{V, S, M (a pinch of graveyard dirt)}
	\spDuration{1 hour}
}
...
\begin{spell}{Glyph of Warding}{PHB}{3rd-level abjuration}
{
	\spTime{1 hour}
	\spRange{Touch}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, the damage of an explosive runes glyph increases by 1d8 for each slot level above 3rd. If you create a spell glyph, you can store any spell of up to the same level as the slot you use for the glyph of warding.
\end{spell}
...
\begin{spell}{Intellect Fortress}{TCE}{3rd-level abjuration}
{
	\spTime{1 action}
	\spRange{30 feet}
	\spComponents{V}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, you can target one additional creature for each slot level above 3rd. The creatures must be within 30 feet of each other when you target them.
\end{spell}

\begin{spell}{Leomund's Tiny Hut}{PHB}{3rd-level evocation (ritual)}
{
	\spTime{1 minute}
	\spRange{Self (10-foot-radius hemisphere)}
...
\begin{spell}{Major Image}{PHB}{3rd-level illusion}
{
	\spTime{1 action}
	\spRange{120 feet}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 6th level or higher, the spell lasts until dispelled, without requiring your concentration. In this form it is sometimes considered a different spell, known as Permanent Image.
\end{spell}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, the healing increases by 1d4 for each slot level above 3rd.
\end{spell}

\begin{spell}{Motivational Speech}{A Inc.}{3rd-level enchantment}
{
	\spTime{1 minute}
	\spRange{60 feet}
	\spComponents{V}
...
\note{At Higher Levels.} When you cast this spell using a spell slot of 4th level or higher, the temporary hit points increase by 5 for each slot level above 3rd.
\end{spell}
...
\begin{spell}{Nondetection}{PHB}{3rd-level abjuration}
{
	\spTime{1 action}
	\spRange{Touch}
	\spComponents{V, S, M (a pinch of diamond dust worth 25 gp sprinkled over the target, which the spell consumes)}
	\spDuration{8 hours}
}
...
\begin{spell}{Sending}{PHB}{3rd-level evocation}
{
	\spTime{1 action}
	\spRange{Unlimited}
	\spComponents{V, S, M (a short piece of fine copper wire)}
	\spDuration{1 round}
}
...
\begin{spell}{Speak with Plants}{PHB}{3rd-level transmutation}
{
	\spTime{1 action}
...
\begin{spell}{Stinking Cloud}{PHB}{3rd-level conjuration}
{
	\spTime{1 action}
	\spRange{90 feet}
	\spComponents{V, S, M (a rotten egg or several skunk cabbage leaves)}
	\spDuration{Concentration, up to 1 minute}
}
...
\begin{spell}{Tongues}{PHB}{3rd-level divination}
{
	\spTime{1 action}
	\spRange{Touch}
	\spComponents{V, M (a small clay model of a ziggurat)}
	\spDuration{1 hour}
}
